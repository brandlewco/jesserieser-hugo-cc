...
collection_blocks:
  ...
  - _bookshop_name: collections/media-row
    row_alignment: between
  - _bookshop_name: collections/media-element
    caption: <strong>1.</strong> <em>A Vanishing American Folklore</em></p>
    color: "#DAECB9"
  ...
  - _bookshop_name: collections/media-row
    row_alignment: between
  - _bookshop_name: collections/media-element
    caption: <strong>1.</strong> <em>The Class of 99 Turns 30</em></p>
    color: "#D0ECE8"
    ...
    width: "25"
  - _bookshop_name: collections/media-element
    caption: <strong>5.</strong> <em>Makenzie Gossage</em></p>
    color: "#EAB7C1"
  ...
  - _bookshop_name: collections/media-element
    ...
    width: "50"
  - _bookshop_name: collections/media-element
    caption: <strong>3.</strong> <em>Sounds of Cement</em></p>
    color: "#0A0A0A"
  ...
  - _bookshop_name: collections/media-row
    row_alignment: between
  - _bookshop_name: collections/media-element
    caption: <strong>2.</strong> <em>Autobiography of a Contact Sport</em></p>
    color: "#E7E7ED"
  ...
  - _bookshop_name: collections/media-row
    row_alignment: between
  - _bookshop_name: collections/media-element
    caption: <strong>1.</strong> <em>Autobiography of a Contact Sport</em></p>
    color: "#E0E0E0"
  ...
  - _bookshop_name: collections/media-row
    row_alignment: between
  - _bookshop_name: collections/media-element
    caption: <strong>4.</strong> <em>E* Trade for Mullen Lowe Boston</em></p>
    color: "#E7EEF1"
  ...
  - _bookshop_name: collections/media-element
    align_y: start
    caption: <strong>4.</strong> <em>Eric Stonestreet AT&amp;T for BBDO</em></p>
  ...
  - _bookshop_name: collections/media-element
    ...
    width: "40"
  - _bookshop_name: collections/media-element
    caption: <strong>4.</strong> <em>Crazy Explosive Primeknit </em></p>
    color: "#030303"
